...
require(["moment"], function() {
  var $header, $issue, $issues, data, day, header, key, lastDay, padNumber, project, sum, sumByDay, sumByIssue, sumOverall, _i, _j, _ref, _ref1;
  ...
  return $(".edit-time").on("click", function(e) {
